# -*- coding: utf-8 -*-
"""Running Stock Models.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13DM09pqvriwMLbxuy2Wqb3bXx1aCPkmc
"""
...
def run_stock_analysis(tickers):
    ...
    for symbol in tickers:
        try:
            ...
            # 1. FIX: Flatten MultiIndex columns (The 2026 yfinance update fix)
            ...
            # 3. SENTIMENT MODELING (Boom Extension & Volume)
...
"""### Generate HTML for Local Hosting

I will now convert the styled DataFrame into an HTML file. You can download this file and open it with any web browser on your computer to view the results locally.
"""

html_output = styled_df.to_html(escape=False)

# You can add basic HTML structure around it if you want a complete page
# full_html = f"""
# <!DOCTYPE html>
# <html>
# <head>
...
#         /* Add any custom CSS from the styled_df if needed, although to_html usually embeds it */
#     </style>
# </head>
# <body>
...
# print("HTML file 'stock_analysis_results.html' created successfully. You can download it from the Colab file browser (left sidebar -> folder icon).")
